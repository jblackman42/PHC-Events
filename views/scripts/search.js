...
const searchBarSetup = () => {
  const searchInput = document.getElementById('event-search-input');
  const searchResultsContainer = document.querySelector('.search-results');
  const calendarWidget = document.querySelector('phc-calendar');
  const { events, showDetailsPopup } = calendarWidget;
...
const handleSearchResult = (eventId, day) => {
  ...
  const searchResultsContainer = document.querySelector('.search-results');
  const calendarWidget = document.querySelector('phc-calendar');
  const { showDetailsPopup } = calendarWidget;
    searchInput.value = '';
    searchResultsContainer.innerHTML = '';
    searchResultsContainer.style.display = 'none';
    searchResultsContainer.style.visibility = 'hidden';
    showDetailsPopup(day, eventId)
}
